...
<p>All of the <a href="{root_url}tags/form.html#variables">single variables</a> available in the <kbd>Form Tag</kbd> are also available in the <dfn>Entries Tag</dfn>.</p>
...
<p>All of the <a href="{root_url}tags/form.html#variable_pairs">variable pairs</a> available in the <kbd>Form Tag</kbd> are also available in the <dfn>Entries Tag</dfn>.</p>
...
<p>Note however that it is often easier to use the {field_name} and {field_value} variables provided by the <a href="{root_url}tags/form.html#var_fields">{fields} variable pair</a> to render a template with values from the entry. This way, a single template can render entries for any of your forms.</p>
