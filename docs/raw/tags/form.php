...
<p>In fact, the <kbd>Simple Form Tag</kbd> actually calls the <kbd>Full Form Tag</kbd> behind the scenes to generate its markup.</p>
...
<p>The simple tag also generates a default set of CSS and JS code to power the front-end of the form. You can disable this by using the <b>{exp:proform:disable_head}</b> tag before you can the form tag. This allows you to use the built-in HTML but provide your own CSS and JS.</p>
