...
<p>In fact, the <kbd>Simple Form Tag</kbd> actually calls the <kbd>Full Form Tag</kbd> behind the scenes to generate it's markup.</p>

<p><dfn>ProForm</dfn> will never force any particular markup on you - you should have full control over the layout and implementation of your forms, if you so desire. At the same time, we provide the default markup generated by the simple tag in order to allow for getting started more quick.</p>
