...
<table>
    <tbody>
        ...
        <tr>
            <td><b>Length</b></td>
            <td>Length limit on the field. If the length is not specified, it will be set to 255 characters. This option is not required for many field types - only text, secure, and member_data require it.</td>
        </tr>
        <tr>
...
<p>Note that the Default HTML Control values provided here are based on the <a href="{root_url}tags/form/template.html">Sample Template</a>, which is similar to the markup generated by the <a href="{root_url}tags/form.html#simple">Simple Form Tag</a>. If you don't like the elements that we generate by default, you can easily be customize your output by simply using your own template based on the Sample Template.</p>
