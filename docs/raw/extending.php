...
<tr><td colspan="3">
    <p><b>Description</b></p>
    <p>This hook is called just before inserting the data for the form submission into the database table for this field. This can be used to push the final data array to an external source, generating some sort of custom notification, as well as changing the data to actually be stored in the DB.<p></td>
</tr>
<!-------------------->
